      ...
      >
        <Table>
          <TableHead sx={{ background: "#F3F6F9" }}>
            <TableRow>
              <TableCell sx={{ color: "black", borderBottom: "white" }}>
                Position
              </TableCell>
              <TableCell sx={{ color: "black", borderBottom: "white" }}>
                Participant Name
              ...
              <TableCell
                sx={{ color: "black", borderBottom: "white", textAlign: "end" }}
              >
                Score
              </TableCell>
            </TableRow>
            ...
            {data?.map((row, index) => (
              <TableRow
                ...
                sx={{
                  ...
                  color: "#949494",
                  borderBottom:
                    (index + 1) % 3 === 0 ? "1px solid #949494" : "none",
                }}
              >
                <TableCell sx={{ color: "black", borderBottom: "white" }}>
                  {" "}
                ...
                <TableCell sx={{ color: "black", borderBottom: "white" }}>
                  ...
                  <Typography sx={{ display: "flex" }}>
                    <Typography>
                      <Avatar src={row.name} alt={`Avatar ${index}`} />
                    </Typography>
                    <Typography sx={{ padding: "8px" }}>{row.name}</Typography>
                  </Typography>
                </TableCell>
                <TableCell
                  sx={{
