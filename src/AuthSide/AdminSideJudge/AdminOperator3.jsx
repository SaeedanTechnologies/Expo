...
<Divider/>
      <Box
        ...
        gap={3}
      >
    <Button variant="contained"  sx={{width:'100%', textTransform:'none', backgroundColor:'#f5c0c1', color:'black', fontWeight:600 }}
    onClick={handleiFrame}

    >
          Copy iframe link
        </Button>
        <Button variant="contained" color="primary" sx={{width:'100%', textTransform:'none'}}>
          Now Judge Hamza
        </Button>
      </Box>
    </Box>
